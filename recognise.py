...
if __name__ == "__main__":
    ...
    def response(phrase, listener):
        ...
        if phrase == 'call':  
            listener2 = speech.listenfor(list,responsekill)
